...
"""
  ...
  parameters {
    ...
    booleanParam(name: 'RUN_TESTS', defaultValue: false, description: 'TODO: Kafka Connect 이미지 검증 명령 추가 후 true로 전환하세요.')
  ...
  stages {
    ...
    stage('Test') {
      ...
      steps {
        error 'TODO: Kafka Connect image smoke test 명령을 추가하세요.'
      }
    }
